...
public class Order extends JFrame implements Frame{
        ...
        addButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (LoginInfo.getDeptNo().equals("商家")){
                    sqlLanguage = "INSERT INTO Orders(ordNo, selNo, ordTime, ordSendtime, ordQuantity, ordPayment, ordDiscount, prtRemark) " +
                            "VALUES(?,?,?,?,?,?,?,?) ";
                }else {
                    sqlLanguage = "INSERT INTO Orders(ordNo, selNo, empNo, ordTime, ordSendtime, ordQuantity, ordPayment, ordDiscount, prtRemark) " +
                            "VALUES(?,?,?,?,?,?,?,?,?) ";
                }
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (LoginInfo.getDeptNo().equals("商家")){
                    sqlLanguage = "UPDATE Orders SET ordNo = ?, selNo = ?, ordTime = ?, ordSendtime = ?, ordQuantity = ?, " +
                            "ordPayment = ?, ordDiscount = ?, prtRemark  = ? " +
                            "WHERE ordNo = ?";
                }else {
    ...
    public void initTable() {
        final Object[] columnNames = {"订单编号", "商家编号", "经办人编号", "订购时间", "预定发货时间", "总数量","总价", "折扣", "备注"};
        Object[][] rowData = {};
    ...
    public String[] getStrings() {
        String ordNo, selNo, empNo, ordTime, ordSendtime, ordQuantity, ordPayment, ordDiscount, prtRemark;
        ordNo = getOrdNo();
        ...
        if (LoginInfo.getDeptNo().equals("商家")){
            ...
            return new String[]{ordNo, selNo, ordTime, ordSendtime, ordQuantity, ordPayment, ordDiscount, prtRemark};
        }else {
            ...
            return new String[]{ordNo, selNo, empNo, ordTime, ordSendtime, ordQuantity, ordPayment, ordDiscount, prtRemark};
        }
    }
